...
export const fallbackProfile = {
  ...
  summary:
    "Full Stack Developer with professional experience building web applications, REST APIs, and data-driven systems using Python, .NET, JavaScript and React.",
...
export const fallbackSkills = [
  { id: 1, group: "Programming Languages", group_name: "Programming Languages", items: ["Python", "C#", "JavaScript"], sort_order: 0 },
  { id: 2, group: "Backend Frameworks", group_name: "Backend Frameworks", items: ["Flask", "FastAPI", "Django", "Django REST Framework", "Scrapy", "ASP.NET Core"], sort_order: 1 },
  { id: 3, group: "Databases", group_name: "Databases", items: ["MySQL", "PostgreSQL", "MongoDB", "Elasticsearch", "Neo4j", "Redis"], sort_order: 2 },
  { id: 4, group: "Messaging & Realtime", group_name: "Messaging & Realtime", items: ["Kafka"], sort_order: 3 },
  { id: 5, group: "Frontend", group_name: "Frontend", items: ["React", "HTML/CSS"], sort_order: 4 },
  { id: 6, group: "Architecture", group_name: "Architecture", items: ["Microservices", "Clean Architecture", "MVC", "MVT"], sort_order: 5 },
  { id: 7, group: "Auth & Security", group_name: "Auth & Security", items: ["JWT", "Role-Based Access Control", "API Security", "Rate Limiting"], sort_order: 6 },
  { id: 8, group: "Familiar With", group_name: "Familiar With", items: ["Docker", "Kubernetes", "Azure", "Playwright", "Celery"], sort_order: 7 },
];
...
export const fallbackPortfolio: PortfolioData = {
  ...
  education: fallbackEducations[0] as any,
